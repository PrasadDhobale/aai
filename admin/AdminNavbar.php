...
if(!$_SESSION['isAdminLogin']){
    ...
    <head>
        ...
        <title>AAI Admin Dashboard</title>
    ...
    <body>
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            ...
            <a class="navbar-brand fw-bold" href="<?php echo BASE_URL; ?>/admin">Dashboard</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="<?php echo BASE_URL; ?>admin/area.php">Area</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo BASE_URL; ?>admin/department.php">Department</a>
                </li>
                <li class="nav-item">
