<?php
session_start();
if(!$_SESSION['isContractorLogin']){
    header("Location: login.php");
}else{
    require("../Connection.php");
    $roleId = $_SESSION['roleId'];
    $role = $_SESSION['role'];
    $userId = $_SESSION['contractor']['contractor_id'];
    ?>
    <!doctype html>
    <html lang="en">
    <head>
        ...
        <title>AAI Contractor Dashboard</title>
    ...
    <body>
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item dropdown">
                    ...
                    <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#contractorProfileModal">Profile</a></li>
        ...
        <div class="modal fade" id="contractorProfileModal" tabindex="-1" aria-labelledby="contractorProfileModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="contractorProfileModalLabel">Profile</h1>
                ...
                <div class="modal-body">
                    <table class="table">
                        <tr>
                            <th>ID</th>
                            <td><?php echo $_SESSION['contractor']['contractor_id']; ?></td>
                        </tr>
                        <tr>
                            <th>Name</th>
                        ...
                        <tr>
                            <th>Contract ID</th>
                            <td><?php echo $_SESSION['contractor']['contract_id']; ?></td>
                        </tr>
                        <tr>
                            <th>Email ID</th>
                        ...
                        <tr>
                            <th>Reg Time</th>
                            <td><?php echo (date("d-M-Y H:i", strtotime($_SESSION['contractor']['reg_time']))) ?></td>
                        </tr>
                    </table>
                </div>
                        ...
                        <div class="row justify-content-center">                            
                            <form action="#" method="POST" onsubmit="return submitForm()">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" value="<?php echo $_SESSION['contractor']['password']; ?>" id="currentPassword" name="currentPassword" required readonly>
                                    </div>
                                </div>
                                <div class="mb-3 row">
